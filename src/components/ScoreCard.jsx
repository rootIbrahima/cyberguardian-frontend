...
export default function ScoreCard({ score = 0, breakdown = null, sslScore = null, sslGrade = null }) {
  ...
  const bars = breakdown?.length
    ...
    : sslScore != null
    ? [{ label: 'SSL/TLS', pts: sslScore, max: 25 }]
    : []
    ...
    <div className="flex flex-col items-center text-center">
      ...
      {sslGrade && (
        <div className="mt-3 text-[12px] text-gray-500">
          Grade SSL <span className="font-bold font-mono text-gray-800">{sslGrade}</span>
        </div>
      )}
            ...
            return (
              <div key={b.label}>
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <span className="ml-auto font-mono text-[12px] font-bold text-gray-700">{b.pts}/{b.max}</span>
                </div>
